...
class CsvWriter {
    ...
    constructor(params) {
        ...
        this._csvConverter = params.csvConverter;

        this._firstWrite = true;
    }

    writeRecords(records) {
        const headerString = this._firstWrite && this._csvConverter.getHeaderString();
        const recordsString = this._csvConverter.convertRecords(records);
